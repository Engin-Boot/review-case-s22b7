...
namespace SenderTest
{
    public class SenderTest
    {
        ...
        {
            string path = "reviewreport.csv";
            Assert.False(PathExistance.CheckPathExistOrNot(path));
            string path1 = "D:/a/review-case-s22b7/review-case-s22b7/sample-review/review-report.csv";
        ...
        {
            //series of words
            string path = "D:/a/review-case-s22b7/review-case-s22b7/sample-review/review-report.csv";
